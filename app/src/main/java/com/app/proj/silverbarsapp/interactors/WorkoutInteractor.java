...
import com.app.proj.silverbarsapp.database_models.MySavedWorkout;
...
public class WorkoutInteractor {
    ...
    public void saveWorkout(com.app.proj.silverbarsapp.models.Workout workout, WorkoutCallback callback) throws SQLException {
    ...
    private void insertTypes(com.app.proj.silverbarsapp.models.ExerciseRep exerciseRep, Exercise exercise) throws SQLException {
