...
import com.app.proj.silverbarsapp.callbacks.SavedWorkoutsCallback;
...
public class SavedWorkoutsInteractor {
    ...
    private void workoutsReady(SavedWorkoutsCallback callback) throws SQLException {
        ...
        for (MySavedWorkout my_saved_workout:  helper.getSavedWorkoutDao().queryForAll()){
            ...
            ArrayList<com.app.proj.silverbarsapp.models.ExerciseRep> exerciseReps = new ArrayList<>();
            ...
            for (ExerciseRep exerciseRep_database: my_saved_workout.getExercises()){
                ...
                List<com.app.proj.silverbarsapp.models.Muscle> muscles = new ArrayList<>();
                ...
                for (Muscle muscle: exercise_database.getMuscles()){
                    muscles.add(new com.app.proj.silverbarsapp.models.Muscle(muscle.getMuscle(), muscle.getMuscle_activation(), muscle.getClassification(), muscle.getProgression_level()));
                }
                
                //re-create exercise object from database
                com.app.proj.silverbarsapp.models.Exercise exercise =
                        new com.app.proj.silverbarsapp.models.Exercise(
                ...
                //
                exerciseReps.add(
                        new com.app.proj.silverbarsapp.models.ExerciseRep(
            ...
            if (my_saved_workout.getSaved()){
                workouts.add(new com.app.proj.silverbarsapp.models.Workout(
