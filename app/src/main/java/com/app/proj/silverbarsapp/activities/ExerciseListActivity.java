...
import com.app.proj.silverbarsapp.adapters.ExercisesAdapter;
import com.app.proj.silverbarsapp.components.DaggerExerciseListComponent;
...
public class ExerciseListActivity extends BaseActivity implements ExerciseListView {
    ...
    private void verifyExercises(){
        ...
        if (mExercisesSelected == null){
            ...
            Log.v(TAG,"mExercisesSelected"+mExercisesSelected);
