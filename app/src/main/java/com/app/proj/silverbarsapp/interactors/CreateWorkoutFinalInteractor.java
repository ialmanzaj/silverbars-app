...
import com.app.proj.silverbarsapp.database_models.UserWorkout;
...
public class CreateWorkoutFinalInteractor {
    ...
    public void insertWorkout(com.app.proj.silverbarsapp.models.Workout workout, CreateWorkoutFinalCallback callback) throws SQLException {
            ...
            for (com.app.proj.silverbarsapp.models.ExerciseRep exerciseRep: workout.getExercises()){
    ...
    private Exercise insertExercise(com.app.proj.silverbarsapp.models.ExerciseRep exerciseRep) throws SQLException {
    ...
    private void insertTypesOfExercise(com.app.proj.silverbarsapp.models.ExerciseRep exerciseRep, Exercise exercise) throws SQLException {
    ...
    private void insertMuscles(com.app.proj.silverbarsapp.models.ExerciseRep exerciseRep, Exercise exercise) throws SQLException {
        //set musles to database
        for (com.app.proj.silverbarsapp.models.Muscle muscle: exerciseRep.getExercise().getMuscles()){
