 ...
 */
public class AdaptersUtilities {

    private static final String TAG = "AdaptersUtilities";
...
*/
    ...
    public static Bitmap loadImageFromCache(String imageURI) {
        Bitmap bitmap = null;
    ...
    public static boolean writeResponseBodyToDisk(ResponseBody body, String imgName) {
