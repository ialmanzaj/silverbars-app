...
import com.app.app.silverbarsapp.adapters.ExerciseDetailMonthlyAdapter;
...
public class ExerciseDetailMonthlyActivity extends AppCompatActivity {

    private static final String TAG = ExerciseDetailMonthlyActivity.class.getSimpleName();
    ...
    private void setupAdapter(ArrayList<ExerciseProgression> exercises, int type_date){
        ...
        mExercisesList.setAdapter(new ExerciseDetailMonthlyAdapter(exercises,type_date));
    }
