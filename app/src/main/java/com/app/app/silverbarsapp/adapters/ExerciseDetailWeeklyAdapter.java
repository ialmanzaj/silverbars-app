 ...
 */
public class ExerciseDetailWeeklyAdapter extends RecyclerView.Adapter<ExerciseDetailWeeklyAdapter.ProgressionViewHolder> {

    private static final String TAG = ExerciseDetailWeeklyAdapter.class.getSimpleName();

    private ArrayList<ExerciseProgression> exercises;
    private Utilities utilities = new Utilities();
    private int type_date;

    public ExerciseDetailWeeklyAdapter(ArrayList<ExerciseProgression> exercises,int type_date) {
    ...
    @Override
    public ExerciseDetailWeeklyAdapter.ProgressionViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        switch (viewType){
            case BETTER:
                return new ExerciseDetailWeeklyAdapter.ProgressionViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(
    ...
    @Override
    public void onBindViewHolder(ExerciseDetailWeeklyAdapter.ProgressionViewHolder viewHolder, int position) {
