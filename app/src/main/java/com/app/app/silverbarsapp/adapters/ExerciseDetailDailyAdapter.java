 ...
 */
public class ExerciseDetailDailyAdapter  extends RecyclerView.Adapter<ExerciseDetailDailyAdapter.ProgressionViewHolder> {

    private static final String TAG = ExerciseDetailDailyAdapter.class.getSimpleName();

    private ArrayList<ExerciseProgression> exercises;
    private Utilities utilities = new Utilities();
    private int type_date;

    public ExerciseDetailDailyAdapter(ArrayList<ExerciseProgression> exercises,int type_date) {
    ...
    @Override
    public ExerciseDetailDailyAdapter.ProgressionViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        switch (viewType){
            case BETTER:
                return new ExerciseDetailDailyAdapter.ProgressionViewHolder(LayoutInflater.from(viewGroup.getContext()).inflate(
    ...
    @Override
    public void onBindViewHolder(ExerciseDetailDailyAdapter.ProgressionViewHolder viewHolder, int position) {
